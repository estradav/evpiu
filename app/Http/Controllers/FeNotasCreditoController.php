...
class FeNotasCreditoController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            return datatables::of($data)
                ->addColumn('opciones', function($row){
                    $btn = '<div class="btn-group ml-auto float-center">'.'<a href="/nc/'.$row->id.'/edit" class="btn btn-sm btn-outline-light" id="edit-fac"><i class="far fa-edit"></i></a>';
    ...
    public function NotasCreditoWebService(Request $request)
    {
        $Notas_credito = $request->selected;
        $Notas_credito = json_decode($Notas_credito);
        $resultados = [];
