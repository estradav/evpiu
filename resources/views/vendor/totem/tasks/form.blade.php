...
@section('page_title',  $task->exists ? 'Actualizar' : 'Crear'. ' Tarea')
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="position-relative form-group">
                            ...
                            <small class="form-text text-muted">Proporcione un nombre descriptivo para su tarea.</small>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="position-relative form-group">
                            ...
                            <small class="form-text text-muted">Comando que sera ejecutado.</small>
                        </div>
                    </div>
                </div>
            </form>
