                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                    ...
                                    <select id="tipo_via" name="tipo_via" class="form-control">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                    ...
                                    <select id="complemento1" name="complemento1" class="form-control">
                                        <option value="" selected>Selecciona...</option>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                    ...
                                    <input id="numero2" name="numero2" type="number" class="form-control">
                                </div>
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                    ...
                                    <select id="complemento2" name="complemento2" class="form-control">
                                        <option value="" selected>Selecciona</option>
                                        <option value="Este">Este</option>
                                        <option value="Norte">Norte</option>
                                        <option value="Oeste">Oeste</option>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3">
                                    ...
                                    <input id="numero3" name="numero3" type="number" class="form-control">
                                </div>
                            </div>
                            <br>
