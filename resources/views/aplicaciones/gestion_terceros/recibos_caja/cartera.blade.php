...
@section('page_title','RC - Anticipos Cartera')

@section('action_recaptcha')
    {!! htmlScriptTagJsApi([ 'action' => 'recibos_caja_cartera' ]) !!}
@stop
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped table-sm text-center" id="table_anticipos">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>VENDEDOR</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-sm">
                                                ...
                                                <button type="button" class="btn btn-light aprobar_anticipo" id="{{ $row->id.','.$row->state }}" data-toggle="tooltip" data-placement="top" title="Aprobar"><i class="fas fa-check-double"></i></button>
                                                <button type="button" class="btn btn-light rechazar_anticipo" id="{{ $row->id.','.$row->state }}" data-toggle="tooltip" data-placement="top" title="Rechazar"><i class="fas fa-window-close"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
...
@section('modal')
    ...
    <div class="modal fade" id="ver_anticipo_modal" tabindex="-1" role="dialog" aria-labelledby="ver_anticipo_modal" aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ver_anticipo_modal_title"></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="ver_anticipo_modal_body">
