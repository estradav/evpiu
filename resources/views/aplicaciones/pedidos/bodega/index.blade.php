...
@section('action_recaptcha')
    {!! htmlScriptTagJsApi([ 'action' => 'pedidos_bodega' ]) !!}
@stop

@section('content')
    @can('aplicaciones.pedidos.bodega.index')
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-sm table-striped" id="table_terminados">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>OC</th>
...
@push('javascript')
    ...
    <script type="text/javascript" src="{{ asset('aplicaciones/pedidos/_bodega/index.js') }}"> </script>
@endpush
