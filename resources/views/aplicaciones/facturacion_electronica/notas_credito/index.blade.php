                ...
                <div class="page-title-heading">
                    ...
                    <div>Notas credito
                        <div class="page-title-subheading">
                            Edicion, validacion y envio de notas credito al Webservice de fenalco.
                        </div>
                    </div>
                </div>
            </div>
...
@push('javascript')
    ...
    <script type="text/javascript" src="{{ asset('aplicaciones/facturacion_electronica/notas_credito/index.js') }}"></script>
@endpush
