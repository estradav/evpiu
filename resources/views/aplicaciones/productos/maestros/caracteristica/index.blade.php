...
@section('page_title', 'Maestros (Caracteristica)')

@section('action_recaptcha')
    {!! htmlScriptTagJsApi([ 'action' => 'maestros_caracteristica' ]) !!}
@endsection

@section('content')
    @can('aplicaciones.maestros.caracteristica.index')
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="main-card mb-3 card">
                    @can('aplicaciones.maestros.caracteristica.nuevo')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group ml-auto">
                                                    @can("aplicaciones.maestros.caracteristica.editar")
                                                    ...
                                                    @endcan
                                                    @can("aplicaciones.maestros.caracteristica.eliminar")
...
@push('javascript')
    <script type="text/javascript" src="{{ asset('aplicaciones/productos/maestros/caracteristica.js') }}"> </script>
@endpush
