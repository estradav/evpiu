...
@section('action_recaptcha')
    {!! htmlScriptTagJsApi([ 'action' => 'maestros_tipo_producto' ]) !!}
@endsection

@section('content')
    @can('aplicaciones.maestros.tipo_producto.index')
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="main-card mb-3 card">
                    @can('aplicaciones.maestros.tipo_producto.agregar')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group ml-auto">
                                                    @can("aplicaciones.maestros.tipo_producto.editar")
                                                    ...
                                                    @endcan
                                                    @can("aplicaciones.maestros.tipo_producto.eliminar")
...
@endsection
@push('javascript')
    <script type="text/javascript" src="{{ asset('aplicaciones/productos/maestros/tipo_producto.js') }}"> </script>
@endpush
