<title>Acceso restringido - EVPIU</title>
<style>
...
<div class="denied__wrapper">
    <h1>403</h1>
    <h3>No tienes roles asignados, por favor comunicate a la ext: 102 o escribenos al correo auxsistemas@estradavelasquez.com.</h3>
    ...
    <a href="javascript:void(0)"><button class="denied__link" onclick="location.reload()">REFRESCAR</button></a>
    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><button class="denied__link">Cerrar Sesion</button> </a>
