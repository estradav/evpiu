<title>Pagina no encontrada - EVPIU</title>
<style>
...
<div class="denied__wrapper">
    <h1>404</h1>
    <h3>PERDIDO EN EL <span>ESPACIO</span> EVPIU?  Hmm, parece que esa página no existe.</h3>
    ...
    <a href="{{route('home')}}"><button class="denied__link">Pagina principal</button></a>
