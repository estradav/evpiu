...
@section('module_title', 'Pedidos (Produccion)')

@section('subtitle', 'Esta aplicacion permite aprobar o rechazar pedidos para el area de Produccion.')
{{--
@section('breadcrumbs')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="EstadoPedido" id="EstadoPedido" class="form-control">
                                        ...
                                        <option value="8">Completar y enviar a Bodega</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12">
