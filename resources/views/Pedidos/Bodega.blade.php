...
@section('page_title', 'Pedidos (Bodega)')

@section('module_title', 'Pedidos (Bodega)')

@section('subtitle', 'Esta aplicacion permite aprobar o rechazar pedidos para el area de Bodega.')
{{--
@section('breadcrumbs')
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="EstadoPedido" id="EstadoPedido" class="form-control">
                                        ...
                                        <option value="9">Rechazar y enviar al vendedor</option>
                                        <option value="10">Completar Pedido</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-12">
                ...
                function LoadTable(CodVenUsuario = CodVenUsuario1, Estado = '4') {
                    table = $('.dataTableP').DataTable({
                        ...
                        rowCallback: function (row, data, index) {
                            ...
                            if (data.Estado == 10) {
                                $(row).find('td:eq(8)').html('<label class="alert-success">COMPLETADO</label>');
                            }
                            if (data.Iva == 'Y') {
                            ...
                            if(data.SubEstado == 10){
                                $(row).find('td:eq(9)').html('<label class="alert-success">Completado</label>');
                            }
                        }
                    })
                }
