...
@section('module_title', 'Pedidos (Costos)')

@section('subtitle', 'Esta aplicacion permite aprobar o rechazar pedidos para el area de Costos.')
{{--
@section('breadcrumbs')
