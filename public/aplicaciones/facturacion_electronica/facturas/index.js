            ...
            rowCallback: function( row, data, index ) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data != ''){
                            $(row).find('td:eq(10)').html('<label id="'+id+'" class="text-success">'+data+'</label>')
                        }else{
                            $(row).find('td:eq(10)').html('<a href="javascript:void(0)" id="'+id+'" class="text-danger">Error</a>')
                        }
                    },
                    error: function () {
                        $(row).find('td:eq(10)').html('<a href="javascript:void(0)" id="'+id+'" class="text-danger ErrorEstDianFac">Pendiente</a>')
                    }
                });
