$(document).ready(function () {
    ...
    $(document).on('click', '.edit', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                let linea_id = data.mat_lineas_id;
                ...
                document.getElementById('sublinea').value = data.mat_sublineas_id;
            },
            error: function (data) {
                Swal.fire({
                    icon: 'error',
    ...
    $(document).on('click', '.delete', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "DELETE",
                    url: "/aplicaciones/productos/maestros/material/" + id,
                    success: function (data) {
                        Swal.fire({
                            title: 'Eliminado!',
    ...
    $("#form").validate({
        ...
        submitHandler: function (form) {
            $.ajax({
                url: "/aplicaciones/productos/maestros/material",
                type: "POST",
                data: $('#form').serialize(),
                success: function (data) {
                    Swal.fire({
    ...
    jQuery.extend(jQuery.validator.messages, {
        ...
        select_check: "Por favor seleccione una opcion!"
    });
