        ...
        Route::prefix('aplicaciones')->group(function () {
            ...
            Route::prefix('terceros')->group(function () {
                ...
                Route::prefix('cliente')->group(function () {
                    Route::get('nuevo','Terceros\Clientes\ClientesController@nuevo');
                    Route::get('buscar_cliente','Terceros\Clientes\ClientesController@buscar_cliente');
                    Route::get('editar/{cliente}/show','Terceros\Clientes\ClientesController@show');
                    Route::post('guardar_cliente','Terceros\Clientes\ClientesController@guardar_cliente');
                    Route::get('obtener_log_cambios','Terceros\Clientes\ClientesController@obtener_log_cambios');
                    Route::post('subir_rut','Terceros\Clientes\ClientesController@subir_rut');
                    Route::get('descargar_rut/{file}','Terceros\Clientes\ClientesController@descargar_rut')->name('descargar_rut');
                    Route::post('crear_actividad_economica', 'Terceros\Clientes\ClientesController@crear_actividad_economica');


                    Route::prefix('actualizar')->group(function () {
                        /*actualizacion de datos de cliente*/
                        Route::post('actualizar_direccion1','Terceros\Clientes\ClientesController@actualizar_direccion1');
                        Route::post('actualizar_direccion2','Terceros\Clientes\ClientesController@actualizar_direccion2');
                        Route::post('actualizar_moneda','Terceros\Clientes\ClientesController@actualizar_moneda');
                        Route::post('cambiar_tipo_cliente','Terceros\Clientes\ClientesController@cambiar_tipo_cliente');
                        Route::post('actualizar_contacto','Terceros\Clientes\ClientesController@actualizar_contacto');
                        Route::post('actualizar_telefono1','Terceros\Clientes\ClientesController@actualizar_telefono1');
                        Route::post('actualizar_telefono2','Terceros\Clientes\ClientesController@actualizar_telefono2');
                        Route::post('actualizar_celular','Terceros\Clientes\ClientesController@actualizar_celular');
                        Route::post('actualizar_email_contacto','Terceros\Clientes\ClientesController@actualizar_email_contacto');
                        Route::post('actualizar_email_facturacion_electronica','Terceros\Clientes\ClientesController@actualizar_email_facturacion_electronica');
                        Route::post('actualizar_termino_pago','Terceros\Clientes\ClientesController@actualizar_termino_pago');
                        Route::post('actualizar_descuento','Terceros\Clientes\ClientesController@actualizar_descuento');
                        Route::post('actualizar_vendedor','Terceros\Clientes\ClientesController@actualizar_vendedor');
                        Route::post('actualizar_correos_copia','Terceros\Clientes\ClientesController@actualizar_correos_copia');
                        Route::post('actualizar_rut','Terceros\Clientes\ClientesController@actualizar_rut');
                        Route::post('actualizar_gran_contribuyente','Terceros\Clientes\ClientesController@actualizar_gran_contribuyente');
                        Route::post('actualizar_responsable_iva','Terceros\Clientes\ClientesController@actualizar_responsable_iva');
                        Route::post('actualizar_responsable_facturacion_electronica','Terceros\Clientes\ClientesController@actualizar_responsable_facturacion_electronica');
                        Route::post('actualizar_telefono_facturacion_electronica','Terceros\Clientes\ClientesController@actualizar_telefono_facturacion_electronica');
                        Route::post('actualizar_codigo_ciudad_ext','Terceros\Clientes\ClientesController@actualizar_codigo_ciudad_ext');
                        Route::post('actualizar_grupo_economico','Terceros\Clientes\ClientesController@actualizar_grupo_economico');
                    });
                });
                ...
                Route::prefix('comercial')->group(function () {
                    Route::get('eventos_actividades', 'Comercial\EventoController@index')->name('eventos_actividades');
                    ...
                    Route::get('dashboard', 'Comercial\DashboardController@index')->name('comercial.dashboard');
                    Route::prefix('dashboard')->group(function () {
                        Route::get('consultar_clientes', 'Comercial\DashboardController@consultar_clientes');
                        Route::get('consultar_info_cliente', 'Comercial\DashboardController@consultar_info_cliente');
                        Route::post('guardar_evento', 'Comercial\DashboardController@store');
                    });
                });
